<?php
    ...
    // $mailTo = "zack@farleyfit.com";
    // $headers = "From: ".$email;
    // $txt = "You received a new submission from FarleyFit.com\n\n".$name."\n\n".$message;

    $mailheader = "You received a new submission from FarleyFit.com\n\nName: ".$name."\n\nEmail: ".$email."\n\nMessage: ".$message;
                        ...
                        <div class="gdlr-core-pbf-wrapper" style="padding: 320px 0px 180px 0px;" data-skin="white" id="gdlr-core-wrapper-1">
                            <div class="gdlr-core-pbf-background-wrap" style="background-color: #0a0a0a;">
                                <div
                                    ...
                                    style="opacity: 0.4; background-image: url(../images/contact.jpg); background-size: cover; background-position: center;"
                                        ...
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
                                            <div class="gdlr-core-title-item-title-wrap">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title" style="font-size: 86px; font-weight: 700; letter-spacing: 0px; text-transform: none; color: #ffffff;">
                                                    Success!<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span>
                                                </h3>
                                            </div>
                                            <span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 20px; font-style: normal; letter-spacing: 0px; color: #ffffff; margin-top: 15px;">
    ...
    <div class="zyth-copyright-wrapper">
        <div class="zyth-copyright-container zyth-container">
            <div class="zyth-copyright-text zyth-item-pdlr">Copyright &copy;
                <?php echo date("Y"); ?> <span class="logo">FarleyFit</span>. All Rights
    ...
    <p>Chris is a personal fitness trainer with over 15 years of experience, through teaching classes, to
        one
